...
![discover object](../img/Discover1/image4.png)
...
![dataset repo](../img/Discover1/dataset_repo.png)
...
![sample repo](../img/Discover1/sample_repo.png)
...
![feature repo](../img/Discover1/feature_repo.png)
...
![annot repo](../img/Discover1/annot_repo.png)
...
![dataset level fields](../img/Discover1/image5.png)
...
![dataset level query](../img/Discover1/image8.png)
...
![liver query](../img/Discover1/image9.png)
...
![Microarray Stem Cell](../img/Discover1/image10.png)
...
![microarray stem cell all datasets](../img/Discover1/image11.png)
...
![feature level query 1](../img/Discover1/image12.png)

Instead of just `n` feature values, you can fetch all as well.

![feature level query 1](../img/Discover1/image13.png)
...
![feature level query 2](../img/Discover1/image14.png)
...
![feature level query 2](../img/Discover1/image15.png)
...
![sample level query 1](../img/Discover1/image16.png)

* Dataframe output variant - `get_n_samples_for_field_as_df`

Instead of just `n` feature values, you can fetch all as well.

![sample level query 1](../img/Discover1/image17.png)
...
![sample level query 2](../img/Discover1/image18.png)
...
![sample level query 2](../img/Discover1/image19.png)
...
![sample level query 3](../img/Discover1/image20.png)
...
![sample level query 3](../img/Discover1/image21.png)
...
![annotation query 1](../img/Discover1/image22.png)
...
![annotation query 2](../img/Discover1/image23.png)
