...
### 1.1 Organization of DataLakes on Polly
A data lake on Polly is a collection of datasets organized based on the source of the datasets (the corresponding public data repository). For example, the bulk Transcriptomics datasets in GEO are included in the GEO repository.
...
These are the current disease and tissue-based datalakes (recorded in March 2021):-
