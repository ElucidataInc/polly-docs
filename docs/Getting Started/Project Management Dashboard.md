...
A project contains all your [data](#adding-files-to-your-workspace), [analysis](../Apps/Introduction.md), [notebooks](../Compute/Polly Notebooks.md), and [reports](../Apps/Introduction.md/#reports). They can be accessed through the top panel.
