...
*   Use the differentially expressed results with the output of [RNA Seq Workflow](/RNA Seq Workflow) to integrate multi-omics data in [IntOmix](/IntOmix).
