...
![Polly Dashboard](img/metabolomics_preset_1.png) <center>**Figure 1.** Polly Dashboard</center>
...
![Preset selection](img/metabolomics_preset_2.png) <center>**Figure 2.** Preset selection</center>
...
![Global Inputs](img/metabolomics_preset_3.png) <center>**Figure 3.** Global Inputs</center>
...
![Metabolomics Data Analysis Interface](img/metabolomics_preset_4.png) <center>**Figure 4.** Data Picker interface</center>
...
![Data Picker Output](img/metabolomics_preset_5.png) <center>**Figure 5.** Data Picker Output</center>
...
![PCA Interface](img/metabolomics_preset_6.png) <center>**Figure 6.** PCA Interface</center>
...
![PCA Plot](img/metabolomics_preset_7.png) <center>**Figure 7.** PCA Plot</center>

- **PCA Score**: Table of the first 10 PC values and metadata columns.
![PCA Score](img/metabolomics_preset_8.png) <center>**Figure 8.** PCA Score</center>
...
![Boxplot Interface](img/metabolomics_preset_9.png) <center>**Figure 9.** Boxplot Interface</center>
...
![Boxplot Output](img/metabolomics_preset_10.png) <center>**Figure 10.** Boxplot Output</center>
...
![Differential expression interface](img/metabolomics_preset_11.png) <center>**Figure 11.** Differential expression interface</center>
...
![Differential Expression Parameters](img/metabolomics_preset_12.png)<center>**Figure 12.** Differential Expression Parameter</center>
...
![Bar Plot Interface](img/metabolomics_preset_15.png) <center>**Figure 15.** Bar Plot Interface</center>

The barplot is generated based on the selected cohort column from metadata and selected metabolites.

![Bar Plot](img/metabolomics_preset_16.png) <center>**Figure 16.** Bar Plot Output</center>
...
![Bar Plot](img/metabolomics_preset_17.png) <center>**Figure 17**. Dashboard</center>
