...
![Polly Dashboard](img/lipidomics_preset_1.png) <center>**Figure 1.** Polly Dashboard</center>
...
![App selection](img/lipidomics_preset_2.png) <center>**Figure 2.** App selection</center>
...
![Global Inputs](img/lipidomics_preset_3.png) <center>**Figure 3.** Global Inputs</center>
...
![Lipidomics Data Analysis Interface](img/lipidomics_preset_4.png) <center>**Figure 4.** Data Picker Interface</center>

It will generate three output files:

![Data Picker Output](img/lipidomics_preset_5.png) <center>**Figure 5.** Data Picker Output</center>
...
![PCA Interface](img/lipidomics_preset_6.png) <center>**Figure 6.** PCA Interface</center>
...
![PCA Plot](img/lipidomics_preset_7.png) <center>**Figure 7.** PCA Plot</center>

- **PCA Score**: Table of the first 10 PC values and metadata columns.
![PCA Score](img/lipidomics_preset_8.png) <center>**Figure 8.** PCA Score</center>
...
![Boxplot Interface](img/lipidomics_preset_9.png) <center>**Figure 9.** Boxplot Interface</center>
...
![Boxplot Output](img/lipidomics_preset_10.png) <center>**Figure 10.** Boxplot Output</center>
...
![Differential expression parameters](img/lipidomics_preset_11.png) <center>**Figure 11.** Differential expression interface</center>
...
![Differential Expression Parameters](img/lipidomics_preset_12.png)<center>**Figure 12.** Differential Expression parameters</center>
...
![Differential expression table](img/lipidomics_preset_13.png)<center>**Figure 13.** Differential expression table</center>
...
![Volcano plot](img/lipidomics_preset_14.png)<center>**Figure 14.** Volcano plot</center>
...
![Bar Plot Interface](img/lipidomics_preset_15.png) <center>**Figure 15.** Bar Plot Interface</center>

The barplot is generated based on the selected cohort column from metadata and selected lipids.

![Bar Plot](img/lipidomics_preset_16.png) <center>**Figure 16.** Bar Plot Output</center>
...
![Dashboard](img/lipidomics_preset_17.png) <center>**Figure 17.** Dashboard</center>
