...
The app will open and you should see the overview page which contains a brief **Overview** of the application, it's **Scope of the application** and the **Caveats** as shown below.
